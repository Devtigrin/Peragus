  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-text-tertiary mt-1">Todas as suas operações</p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-surface-elevated">
                  <th className="text-left py-3 px-4 font-medium text-text-tertiary text-xs uppercase tracking-wider">Data</th>
                  <th className="text-left py-3 px-4 font-medium text-text-tertiary text-xs uppercase tracking-wider">ID</th>
                  <th className="text-left py-3 px-4 font-medium text-text-tertiary text-xs uppercase tracking-wider">BRL</th>
                  <th className="text-left py-3 px-4 font-medium text-text-tertiary text-xs uppercase tracking-wider">USDT</th>
                  ...
                  <th className="text-left py-3 px-4 font-medium text-text-tertiary text-xs uppercase tracking-wider">Status</th>
              ...
              <tbody>
                {filtered.length === 0 ? (
                  <tr>
                    <td colSpan={8} className="py-12 text-center text-sm text-text-disabled">
                  ...
                  filtered.map((op) => {
                    ...
                    return (
                      <tr key={op.id} className="border-b border-border/50 hover:bg-surface-hover transition-colors duration-150">
                        <td className="py-3 px-4 text-xs text-text-tertiary">{formatDate(op.createdAt)}</td>
                        ...
                        <td className="py-3 px-4 text-sm text-text-secondary">{op.usdtAmount} USDT</td>
